...
public class FindContentChildren {
     ...
     * j
     * ​
     *   时，可以将第 jjj 块饼干分配给第 i+1i+1i+1 个孩子，分配的结果不会让更多的孩子被满足；当 gi+1>sjg_{i+1}>s_jg
     * i+1
     * ​
     *  >s
     * j
     * ​
     *   时，第 jjj 块饼干无法分配给任何孩子，因此剩下的可用的饼干少了一块，因此分配的结果不会让更多的孩子被满足，甚至可能因为少了一块可用的饼干而导致更少的孩子被满足。
     *
